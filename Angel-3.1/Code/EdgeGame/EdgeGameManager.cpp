...
{
	// TODO - HAUKAP - CONSOLE_DECLARECMDMETHOD(MoveForwards, this, EdgeGameManager, MoveForwards);
	// TODO - HAUKAP - CONSOLE_DECLARECMDMETHOD(MoveBackwards, this, EdgeGameManager, MoveBackwards);
