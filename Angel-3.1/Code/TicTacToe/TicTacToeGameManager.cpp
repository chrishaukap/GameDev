...
{
	// HAUKAP - CONSOLE_DECLARECMDMETHOD(Restart, this, TicTacToeGameManager, Restart);
}
...
void TicTacToeGameManager::init(unsigned width, unsigned height)
{
   m_windowWidth = width;
   m_windowHeight = height;

	m_screens.push_back(new TicTacToeScreen(m_windowWidth,m_windowHeight,GRID_SIZE));    
