...
Color3f TTTGameState::GetPlayerColor() const
{
	return GetPlayerColor(m_turn);
}
Color3f TTTGameState::GetPlayerColor(TTTPlayer player) const
{
	switch(player)
	{
	case X: return Color3f(1,0,0); 
	case O: return Color3f(0,1,0);
