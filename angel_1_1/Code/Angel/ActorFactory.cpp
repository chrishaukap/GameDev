...
void LoadLevel( const String& input )
{
	...
	theConsole.ExecuteFile( String("Config//Level//" + levelName + ".lvl" ) );
...
void ActorFactory::Initialize()
{
	...
	CONSOLE_DECLARECMDSTATIC( LoadLevel, LoadLevel );
...
void ActorFactory::BeginActor( String actorDefFile, int layer )
{
	...
	theConsole.ExecuteFile( String("Config//ActorDef//" + actorDefFile + ".adf" ) );
