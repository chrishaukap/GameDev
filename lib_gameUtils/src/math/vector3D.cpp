...
bool 
utils3D::RectToRectCollision2D(const Vector3& llPointObject1, const Vector3& urPointObject1,
										 const Vector3& llPointObject2, const Vector3& urPointObject2)
{ 
	if (urPointObject1.y < llPointObject2.y) return false;
	if (llPointObject1.y > urPointObject2.y) return false;

	if (urPointObject1.x < llPointObject2.x) return false;
	if (llPointObject1.x > urPointObject2.x) return false;
